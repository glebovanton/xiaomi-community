                    ...
                    switch ($_DBBEQ) {
                        case _tkts.$_Dm()[4][10]:
                            ...
                            return i = 2147483648 & t,
                                o = 2147483648 & e,
                                s = (1073741823 & t) + (1073741823 & e), (n = 1073741824 & t) & (r = 1073741824 & e) ? 2147483648 ^ s ^ i ^ o : n | r ? 1073741824 & s ? 3221225472 ^ s ^ i ^ o : 1073741824 ^ s ^ i ^ o : s ^ i ^ o;
                            break;
                    }
                }
            }
            ...
            while (0 <= --o) {
                ...
                _ < 0 ? $_JBEs(42) == t[$_JBEs(176)](o) && (s = !0) : (s = !1,
                    0 == a ? this[this[$_JBFA(319)]++] = _ : a + n > this[$_JBEs(304)] ? (this[this[$_JBEs(319)] - 1] |= (_ & (1 << this[$_JBEs(304)] - a) - 1) << a,
                        this[this[$_JBFA(319)]++] = _ >> this[$_JBFA(304)] - a) : this[this[$_JBFA(319)] - 1] |= _ << a, (a += n) >= this[$_JBEs(304)] && (a -= this[$_JBFA(304)]));
            }
...
function get_o(slide_length, encodetrace, challenge34, challenge32, passtime, imgload, gt) {
    var o = {
        'lang': 'zh-cn',
        ...
        'ep': {
            ...
            'tm': {
                'a': new Date()['getTime'](),
                'b': new Date()['getTime']() + 68,
                'c': new Date()['getTime']() + 68,
                'd': 0,
                'e': 0,
                'f': new Date()['getTime']() + 5,
                'g': new Date()['getTime']() + 5,
                'h': new Date()['getTime']() + 5,
                'i': new Date()['getTime']() + 5,
                'j': new Date()['getTime']() + 5,
                'k': new Date()['getTime']() + 2,
                'l': new Date()['getTime']() + 7,
                'm': new Date()['getTime']() + 65,
                'n': new Date()['getTime']() + 65,
                'o': new Date()['getTime']() + 71,
                'p': new Date()['getTime']() + 210,
                'q': new Date()['getTime']() + 210,
                'r': new Date()['getTime']() + 210,
                's': new Date()['getTime']() + 210,
                't': new Date()['getTime']() + 668,
                'u': new Date()['getTime']() + 668
            },
            'td': -1
        },
        'h9s9': '1816378497',
